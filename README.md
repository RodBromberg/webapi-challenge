...
- [ ] Mention two parts of Express that you learned about this week.
    Routers and Middleware. Middleware allows one to use a function to check content.
- [ ] Describe Middleware?
    The basis of express, allows you to functions and ways of checking data and even changing them.
- [ ] Describe a Resource?
    Info that can be used. Its unique and may be represented as data also has URL to be represented
- [ ] What can the API return to help clients know if a request was successful?
        status code/ error messages

- [ ] How can we partition our application into sub-applications?
    using index, router, and severs.
## Project Setup
